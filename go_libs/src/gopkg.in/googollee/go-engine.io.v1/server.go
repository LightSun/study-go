...
func defaultTokenChecker(*http.Request) (interface{}, *jwtgo.Token, error) {
	return nil, nil, nil
}
...
type Options struct {
	TokenChecker       func(*http.Request) (interface{}, *jwtgo.Token, error)
...
func (c *Options) getTokenChecker() func(*http.Request) (interface{}, *jwtgo.Token, error) {
	if c != nil && c.TokenChecker != nil {
		return c.TokenChecker
	}
	return defaultTokenChecker
}
...
func NewServer(opts *Options) (*Server, error) {
	...
	return &Server{
		...
		tokenChecker:   opts.getTokenChecker(),
...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// TODO，是否需要带上token或者uid
	_, _, err = s.tokenChecker(r)
	if err != nil {
